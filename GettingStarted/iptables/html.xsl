...
<xsl:import href="/opt/local/share//xsl/docbook-xsl/html/chunkfast.xsl"/>
...
<xsl:template name="user.header.navigation">
  <xsl:comment>#include virtual="/4.0/iptables_getting_started_page_header.html"</xsl:comment>
</xsl:template>
